...
const sr = {
  ...
  kontakt: {
    ...
    form: {
      ...
      message: "Vaše iskustvo / poruka",
      consent: "Saglasan/na sam da Receptor obrađuje moje podatke radi kontakta.",
      submit: "Pošalji poruku",
      success: "Hvala! Vaša poruka je poslata — javićemo se uskoro.",
    },
    careers: {
...
const en: Dict = {
  ...
  kontakt: {
    ...
    form: {
      ...
      message: "Your experience / message",
...
const ru: Dict = {
  ...
  kontakt: {
    ...
    form: {
      ...
      email: "E-mail",
      phone: "Телефон",
      position: "Позиция, на которую претендуете",
      message: "Ваш опыт / сообщение",
      consent: "Согласен(на) на обработку моих данных компанией Receptor для связи.",
      submit: "Отправить сообщение",
      success: "Спасибо! Ваше сообщение отправлено — мы скоро свяжемся.",
    },
    careers: {
